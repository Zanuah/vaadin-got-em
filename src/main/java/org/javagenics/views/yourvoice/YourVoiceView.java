package org.javagenics.views.yourvoice;
...
@Menu(icon = "line-awesome/svg/edit.svg", order = 4)
@Route(value = "page-editor")
public class YourVoiceView extends Main {

    public YourVoiceView() {
