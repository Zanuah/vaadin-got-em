package org.javagenics.views.recruiterfeed;
...
@PageTitle("Recruiter Feed")
@Menu(icon = "line-awesome/svg/list-solid.svg", order = 2)
@Route(value = "feed")
public class RecruiterFeedView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public RecruiterFeedView() {
        addClassName("recruiter-feed-view");
        setSizeFull();
        grid.setHeight("100%");
